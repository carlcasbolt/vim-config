...
"    CC (01/09/2008) - Do not stick the function name in
...
"   CC (01/09/2008) - Do not stick the @access param
"    if l:scope != ""
...
"    exe l:txtBOL . g:pdv_cfg_Commentn . "@subpackage " . g:pdv_cfg_EOL
"    exe l:txtBOL . g:pdv_cfg_CommentTail . g:pdv_cfg_EOL

    " add a line of whitespace
"    exe g:pdv_cfg_BOL . g:pdv_cfg_EOL
